...
class MailchimpBaseTest(unittest.TestCase):
    ...
    def expected_replication_keys(self):
        """Return a dictionary with the key of table name and value as a set of
    ...
    def expected_replication_method(self):
        """Return a dictionary with the key of table name and value of
        replication method."""
        return {
    ...
    def get_bookmark_path(self):
        """Return bookmark path (the path at which bookmark is stored) for the
        stream."""
        return {
            table: properties.get(self.BOOKMARK_PATH, set()) for table, properties in self.expected_metadata().items()
        }

    def expected_automatic_fields(self):
        """Return a dictionary with the key of table name and set of value of
    ...
    def perform_and_verify_table_and_field_selection(self, conn_id, test_catalogs, select_all_fields=True):
        """Perform table and field selection based on the streams to select set
        and field selection parameters.
