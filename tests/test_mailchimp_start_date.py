...
class MailchimpStartDate(MailchimpBaseTest):
    ...
    def run_test(self, expected_streams):
        ...
        self.start_date_2 = self.get_properties(original=False)['start_date']
                ...
                if self.expected_metadata()[stream][self.OBEYS_START_DATE]:
                    ...
                    for replication_date in replication_dates_1:
                        ...
                        self.assertGreaterEqual(
                            self.parse_date(replication_date, self.RECORD_DATETIME_FORMAT), self.parse_date(self.start_date_1, self.START_DATE_FORMAT),
                    ...
                    for replication_date in replication_dates_2:
                        ...
                        self.assertGreaterEqual(
                            self.parse_date(replication_date, self.RECORD_DATETIME_FORMAT), self.parse_date(self.start_date_2, self.START_DATE_FORMAT),
                            msg="Report pertains to a date prior to our start date.\n" +
