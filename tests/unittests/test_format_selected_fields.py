...
class TestFormatSelectedFields(unittest.TestCase):
    def test_format_selected_fields(self):
                ...
                "streams": [
                    {
                        ...
                        "schema": {"properties": {"field1": {}, "field2": {}}},
                        "metadata": [
                            ...
                            {"breadcrumb": ["properties", "field2"], "metadata": {"inclusion": "automatic"}},
                            {
        ...
        stream = ReportEmailActivity(
            state={}, client=client, config={}, catalog=catalog, selected_stream_names=[], child_streams_to_sync=[]
        )
