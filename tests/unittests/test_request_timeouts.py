...
class TestRequestTimeoutsBackoff(unittest.TestCase):
    def test_request_timeout_backoff(self, mocked_request, mock_sleep):
        """Verify request function is backoff for 5 times on Timeout
        exceeption."""
        # Initialize MailchimpClient object
        client = MailchimpClient(config={"access_token": "as"})
        try:
            client.get(path="http://test", url="base_url")
...
class TestRequestTimeoutsValue(unittest.TestCase):
    def test_no_request_timeout_in_config(self, mocked_request):
        ...
        default value(300) is used."""
        # Initialize MailchimpClient object
        client = MailchimpClient(config={"access_token": "as"})

        # Call request method which call requests.Session.request with timeout
        client.request(method="GET", path="http://test", url="base_url")
    ...
    def test_integer_request_timeout_in_config(self, mocked_request):
        ...
        client = MailchimpClient(config={"access_token": "as", "request_timeout": REQUEST_TIMEOUT_INT})
    ...
    def test_float_request_timeout_in_config(self, mocked_request):
        ...
        client = MailchimpClient(config={"access_token": "as", "request_timeout": REQUEST_TIMEOUT_FLOAT})
    ...
    def test_string_request_timeout_in_config(self, mocked_request):
        ...
        client = MailchimpClient(config={"access_token": "as", "request_timeout": REQUEST_TIMEOUT_STR})
    ...
    def test_empty_string_request_timeout_in_config(self, mocked_request):
        ...
        string then default value(300) is used."""
        # Initialize MailchimpClient object
        # empty string timeout in config
        client = MailchimpClient(config={"access_token": "as", "request_timeout": ""})
    ...
    def test_zero_int_request_timeout_in_config(self, mocked_request):
        """Verify that if request_timeout is provided in config with int zero
        value then default value(300) is used."""
        # Initialize MailchimpClient object
        # int zero value in config
        client = MailchimpClient(config={"access_token": "as", "request_timeout": 0})
    ...
    def test_zero_string_request_timeout_in_config(self, mocked_request):
        """Verify that if request_timeout is provided in config with string
        zero in string format then default value(300) is used."""
        client = MailchimpClient(config={"access_token": "as", "request_timeout": "0"})  # string zero value in config
